function del_domain(domain,domain_name) {
    ...
    // var send_del_data =  document.getElementById(send_del_data.id).getAttribute("name")
    // // console.log(send_del_data);
    var data = document.getElementById(domain.id).getAttribute("value");
    var data_name = document.getElementById(domain.id).getAttribute("name");
    // let elem = document.querySelector(domain.id).id;
    // elem.setAttribute('value', '!!!');
    document.getElementById("send_del_data").setAttribute("name",data_name);
    document.getElementById("send_del_data").setAttribute("value",data);
    console.log(data);
